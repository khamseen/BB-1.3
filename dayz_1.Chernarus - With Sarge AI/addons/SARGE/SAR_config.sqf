...
// Humanity Value that gets ADDED for a bandit AI kill (changed from 50)
...
SAR_respawn_waittime = 600; // 10 minutes
...
SAR_sniper_surv_list = ["Survivor1_DZ"]; // the potential classes of the snipers of a survivor group
SAR_soldier_surv_list = ["Survivor2_DZ","SurvivorW2_DZ"]; // the potential classes of the riflemen of a survivor group
