...
// Bandits at Skalisty Castle
_this = createMarker ["SAR_marker_bandits_skal", [13684.5,2885.09,0.001]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [200, 200];
SAR_marker_bandits_skal = _this;
...
//Admin Testing on Skalist Island
//_this = createMarker ["SAR_marker_admin_test", [13951.6,2933.41,0.001]];
//_this setMarkerShape "RECTANGLE";
//_this setMarkeralpha 0;
//_this setMarkerType "Flag";
//_this setMarkerBrush "Solid";
//_this setMarkerSize [10, 10];
//SAR_marker_admin_test = _this;
...
// Bandits at Skalisty Island Castle
[SAR_marker_bandits_skal,3,2,5,"fortify",true] call SAR_AI;
[SAR_marker_bandits_skal,3,3,4,"fortify",true] call SAR_AI;
[SAR_marker_bandits_skal,3,1,6,"fortify",true] call SAR_AI;
[SAR_marker_bandits_skal,3,2,5,"fortify",true] call SAR_AI;
...
//Admin Testing
//[SAR_marker_admin_test,1,0,0,"patrol",true] call SAR_AI;
