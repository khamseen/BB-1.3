...
//####----####----These Settings Can Be Edited ----####----####
	...
	BBTypeOfFlag				= "FlagCarrierUSA_EP1"; //Type of flag Base Building 1.3 will use, you can select any of the flags from the BBAllFlagTypes array (default is FlagCarrierBIS_EP1)
	...
	BBAIGuards 					= 1; //Sarge AI Base Guards/ 1 = Enabled // 0 = Disabled (Will only work if running Sarge AI)
